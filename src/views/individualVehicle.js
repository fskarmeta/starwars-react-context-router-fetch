          ...
          <div className="row d-flex justify-content-center">
            <div className="d-flex flex-column m-2 box col-md-3">
              ...
              <span className="box-text">
                {!!store.currentVehicle && store.currentVehicle.model}
              </span>
            </div>
            <div className="d-flex flex-column m-2 box col-md-3">
            ...
            <div className="d-flex flex-column m-2 box col-md-3">
              ...
              <span className="box-text">
                {!!store.currentVehicle && store.currentVehicle.length}
              </span>
            </div>
            <div className="d-flex flex-column m-2 box col-md-3">
              ...
              <span className="box-text">
                {!!store.currentVehicle &&
                  store.currentVehicle.max_atmosphering_speed}
              </span>
            </div>
            <div className="d-flex flex-column m-2 box col-md-3">
              <span className="box-title">Crew</span>
              <span className="box-text">
                {!!store.currentVehicle && store.currentVehicle.crew}
              </span>
            </div>
            <div className="d-flex flex-column m-2 box col-md-3">
