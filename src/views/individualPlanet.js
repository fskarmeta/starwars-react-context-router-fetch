  ...
  return (
    <div className="container">
      <div
        ...
        style={{ borderBottom: "3px solid rgb(204, 178, 27)" }}
      >
        <div className="col-md-6">
          <img
            className="card-img-top"
            src={`../img/planets/${!!store.currentImg && store.currentImg}.jpg`}
            alt="Card cap"
          />
        </div>
        <div className="col-md-6 d-flex justify-content-center flex-column text-light">
          ...
          <p>
            Donec imperdiet libero non faucibus ultrices. Cras convallis sit
            amet orci eu sodales. Donec viverra tortor et malesuada vulputate.
            Quisque ornare pharetra egestas. Praesent eros diam, rutrum at
            ultricies quis, laoreet ut tellus. Aenean aliquet venenatis felis
            sit amet fermentum. In eget elit non orci fermentum convallis. Nulla
            tincidunt faucibus elit vel pretium. Maecenas ac lacinia dolor.
          </p>
        </div>
      </div>
        ...
        <div className="col-md-12 d-flex justify-content-center">
          <div className="row d-flex justify-content-center">
            ...
            <div className="d-flex flex-column m-2 box col-md-3">
              ...
              <span className="box-text">
                {!!store.currentPlanet && store.currentPlanet.diameter}
              </span>
            </div>
            <div className="d-flex flex-column m-2 box col-md-3">
              <span className="box-title">Climate</span>
              <span className="box-text">
                {!!store.currentPlanet && store.currentPlanet.climate}
              </span>
            </div>
            <div className="d-flex flex-column m-2 box col-md-3">
              <span className="box-title">Gravity</span>
              <span className="box-text">
                {!!store.currentPlanet && store.currentPlanet.gravity}
              </span>
            </div>
            <div className="d-flex flex-column m-2 box col-md-3">
            ...
            <div className="d-flex flex-column m-2 box col-md-3">
              ...
              <span className="box-text">
                {!!store.currentPlanet && store.currentPlanet.population}
              </span>
            </div>
          </div>
        </div>
